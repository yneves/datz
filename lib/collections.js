...
var Collection = classes.createClass({
  ...
  // new Collection(items Array, parent Model) :Collection
  ...
  // .createItem(values) :void
  createItem: function(values) {
    var Model = this.model;
    return new Model(values,this);
  },
  
  // ._emitChange(added Array, removed Array) :void
  _emitChange: function(added,removed) {
    var emitter = this;
    var data = {
      added: added,
      removed: removed,
  ...
  _reset: function(items) {
    ...
    if (this.model) {
      items = items.map(this.createItem.bind(this));
    }
